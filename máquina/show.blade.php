...
<body>
  ...
  <div class="container">
    ...
    <h1>Selecione o modelo da máquina que deseja editar</h1>
    ...
    <div class="col-md">
      <div class="br-card hover">
        <div class="card-content flex">
          <img src="../imgs/upload.png" alt="" class="mt-3 h-full">

          <div class="col relative">
            <h2>Modelo máquina <b>nº1</b></h2>

          <button onclick="window.location.href='edit.blade.php'" class="br-button primary mr-3 absolute -top-7" type="button">Alterar
          </button>
          </div>
        </div>
      </div>
