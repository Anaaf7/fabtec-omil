...
<body>
    ...
    <div class="container col">
        ...
        <h1>Adiocione o funcionário ao setor selecionado</h1>
        ...
        <form action="" method="post">
            <fieldset>
                <div class="col-sm-6 col-lg-4 mb-3">
                    <div class="br-input small">
                        ...
                        <div class="input-group">
                            ...
                            <input class="small" id="input-icon-small" type="text" placeholder="Nome do funcionário" />
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-4 mb-3">
                    <div class="br-input small">
                        <label for="input-icon-small">Código</label>
                        <div class="input-group">
                            <div class="input-icon"><i class="fas fa-user" aria-hidden="true"></i>
                            </div>
                            <input class="small" id="input-icon-small" type="text" placeholder="Nº do funcionário" />
                        </div>
                    </div>
                </div>
                ...
                <button class="br-button primary mr-3" type="button">Adicionar
                </button>
    </div>
    </div>
    </fieldset>
